...
use zktls_att_verification::attestation_data::{verify_attestation_data, AttestationConfig, AttestationData};
use zktls_att_verification::tls_data::JsonData;

mod errors;
use errors::{ZkErrorCode, ZktlsError};

// NOTE-1: Set your own base url(s). maybe multis
const BASE_URLS: [&str; 1] = ["https://api.binance.com/api/v3/account"];
